...
#include "mex.h"
#include "math.h"
#include "../include/opt_solver_strat.h"
...
extern void opt_solver_strat_casadi2forces(opt_solver_strat_float *x, opt_solver_strat_float *y, opt_solver_strat_float *l, opt_solver_strat_float *p, opt_solver_strat_float *f, opt_solver_strat_float *nabla_f, opt_solver_strat_float *c, opt_solver_strat_float *nabla_c, opt_solver_strat_float *h, opt_solver_strat_float *nabla_h, opt_solver_strat_float *hess, solver_int32_default stage, solver_int32_default iteration);
opt_solver_strat_extfunc pt2function_opt_solver_strat = &opt_solver_strat_casadi2forces;


/* Some memory for mex-function */
static opt_solver_strat_params params;
static opt_solver_strat_output output;
static opt_solver_strat_info info;
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
    ...
    if (nrhs != 1) 
	{
        mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help opt_solver_strat_mex' for details.");
    }    
	if (nlhs > 3) 
	{
    ...
    if( mxGetM(par) != 567 || mxGetN(par) != 1 ) 
	{
    mexErrMsgTxt("PARAMS.all_parameters must be of size [567 x 1]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.all_parameters,567);

	}


	#if SET_PRINTLEVEL_opt_solver_strat > 0
	...
	/* call solver */
	exitflag = opt_solver_strat_solve(&params, &output, &info, fp, pt2function_opt_solver_strat);

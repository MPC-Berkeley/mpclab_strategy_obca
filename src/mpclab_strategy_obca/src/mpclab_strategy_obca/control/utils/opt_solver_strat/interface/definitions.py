...
name = "opt_solver_strat"
requires_callback = True
lib = "lib/libopt_solver_strat.so"
lib_static = "lib/libopt_solver_strat.a"
c_header = "include/opt_solver_strat.h"

# Parameter             | Type    | Scalar type      | Ctypes type    | Numpy type   | Shape     | Len
params = \
[("x0"                  , "dense" , ""               , ctypes.c_double, numpy.float64, (542,   1),  542),
 ("xinit"               , "dense" , ""               , ctypes.c_double, numpy.float64, (  6,   1),    6),
 ("all_parameters"      , "dense" , ""               , ctypes.c_double, numpy.float64, (567,   1),  567)]

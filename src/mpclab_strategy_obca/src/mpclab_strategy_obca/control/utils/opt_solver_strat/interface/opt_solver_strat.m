% opt_solver_strat - a fast solver generated by FORCES PRO v4.0.0
%
%   OUTPUT = opt_solver_strat(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = opt_solver_strat(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = opt_solver_strat(PARAMS) returns 

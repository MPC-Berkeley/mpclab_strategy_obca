% opt_solver_naive - a fast solver generated by FORCES PRO v4.0.0
%
%   OUTPUT = opt_solver_naive(PARAMS) solves a multistage problem
%   subject to the parameters supplied in the following struct:
%       PARAMS.x0 - column vector of length 542
%       PARAMS.xinit - column vector of length 6
%       PARAMS.all_parameters - column vector of length 647
%
...
%
%   [OUTPUT, EXITFLAG] = opt_solver_naive(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = opt_solver_naive(PARAMS) returns 

...
#include "mex.h"
#include "math.h"
#include "../include/ws_solver_strat.h"
...
extern void ws_solver_strat_casadi2forces(ws_solver_strat_float *x, ws_solver_strat_float *y, ws_solver_strat_float *l, ws_solver_strat_float *p, ws_solver_strat_float *f, ws_solver_strat_float *nabla_f, ws_solver_strat_float *c, ws_solver_strat_float *nabla_c, ws_solver_strat_float *h, ws_solver_strat_float *nabla_h, ws_solver_strat_float *hess, solver_int32_default stage, solver_int32_default iteration);
ws_solver_strat_extfunc pt2function_ws_solver_strat = &ws_solver_strat_casadi2forces;


/* Some memory for mex-function */
static ws_solver_strat_params params;
static ws_solver_strat_output output;
static ws_solver_strat_info info;
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
    ...
    if (nrhs != 1) 
	{
        mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help ws_solver_strat_mex' for details.");
    }    
	if (nlhs > 3) 
	{
	...
	#if SET_PRINTLEVEL_ws_solver_strat > 0
	...
	/* call solver */
	exitflag = ws_solver_strat_solve(&params, &output, &info, fp, pt2function_ws_solver_strat);
